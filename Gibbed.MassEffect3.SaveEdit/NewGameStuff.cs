...
namespace Gibbed.MassEffect3.SaveEdit
{
    internal static class NewGameStuff
    {
        ...
        public static void DoDarkHorseMe1PlotCopyAndPlotLogicFix(
            this SFXSaveGameFile target)
        {
            if (target.Plot.GetBoolVariable(Constants.PS3DarkHorseME1PlayedPlotCheck_Bool) == true)
            {
                if (
                    target.Plot.GetBoolVariable(
                        Constants.ME2__ME1_Plots_for_ME2__Background_and_Relationships__Kaidan_romance_True) == true)
                {
                    target.Plot.SetIntVariable(
                ...
                if (
                    target.Plot.GetBoolVariable(
                        Constants.ME2__ME1_Plots_for_ME2__Background_and_Relationships__Ashley_romance_True) == true)
                {
                    target.Plot.SetIntVariable(
                ...
                if (
                    target.Plot.GetBoolVariable(
                        Constants.ME2__ME1_Plots_for_ME2__Background_and_Relationships__Liara_romance_True) == true)
                {
                    target.Plot.SetIntVariable(
                ...
                if (target.Plot.GetBoolVariable(Constants.ME2__ME1_Plots_for_ME2__CH2_Virmire__Ash_died) == true &&
                    target.Plot.GetBoolVariable(Constants.ME2__ME1_Plots_for_ME2__CH2_Virmire__Kaidan_died) == true)
                {
                    ...
                    target.Plot.SetBoolVariable(
                        Constants.ME3__ME1_Plots_for_ME3__CH2_Virmire__The_Choice__Rescued_Ash, isFemale == true);
                }
                else
                {
                    var ashleyDied =
                        target.Plot.GetBoolVariable(Constants.ME2__ME1_Plots_for_ME2__CH2_Virmire__Ash_died) == true;
                    target.Plot.SetBoolVariable(
                ...
                var rachniAreAlive =
                    target.Plot.GetBoolVariable(Constants.ME2__ME1_Plots_for_ME2__CH2_Noveria__Rachni_Alive) == true;
                target.Plot.SetBoolVariable(
                ...
                var wrexDied =
                    target.Plot.GetBoolVariable(Constants.ME2__ME1_Plots_for_ME2__CH2_Virmire_Wrex_Died) == true;
                target.Plot.SetBoolVariable(
                    Constants.
